...
export const taskDataThree = [
    ...
    {
        id: 1,
        txt: `Створити функцію <span>getMaxDigit(number)</span> – яка отримує будь-яке число та виводить найбільшу цифру в цьому числі.`,
        answer: [
            maxDigit
        ]
    },
    {
        id: 2,
        txt: `Створити функцію, яка <span>форматує ім'я</span>, роблячи першу букву великою.`,
        answer: [
            correctName
        ]
    },
    {
        id: 3,
        txt: `Створити функцію, яка повертає <span>випадкове</span> ціле число в діапазоні від <span>N</span> до <span>M</span>.`,
        answer: [
            randomNumber
        ]
    },
    {
        id: 4,
        txt: `Створити функцію, яка вираховує суму, що залишається після <span>оплати податку</span>  від зарабітньої плати.`,
        answer: [
            salary
        ]
    },
    {
        id: 5,
        txt: `Створіть функцію <span>генерації випадкового паролю</span> (тільки числа), довжина встановлюється користувачем або по замовчуванню = 8 символам.`,
        answer: [
            randomPass
        ]
    },
    {
        id: 6,
        txt: `Створіть функцію, яка <span>видаляє</span> всі букви з речення.`,
        answer: [
            sentence
        ]
    }
