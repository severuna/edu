...
export const taskDataOne = [
    ...
    {
        id: 13,
        txt: 'Створіть <span>шаблонний рядок</span> та виведіть всі обчислення вчинені в <span>Base частині домашнього завдання у вигляді одного рядка наступного вигляду: Максимальна ціна: 9999.99 Мінімальна ціна: 1111.11 Вартість всіх товарів: 1345.66 ...і так далі',
        answer: [
            patternString
        ]
    }
