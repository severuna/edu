...
export const taskDataFour = [
    ...
    {
        id: 2,
        txt: `Розділіть студентів на <span>пари(хлопець + дівчина)</span> для работи над проєктом.`,
        answer: [
            pairs
        ]
    },
    {
        id: 3,
        txt: `Зіставте пари з попереднього завдання та <span>теми проєктів</span>, над якими студенти будуть працювати.`,
        answer: [
            project
        ]
    },
    {
        id: 4,
        txt: `Зіставте оцінки(<span>marks</span>) зі студентом(<span>students</span>):`,
        answer: [
            test
        ]
    },
    {
        id: 5,
        txt: `Поставте кожній парі <span>випадкову оцінку</span>(від 1 до 5) за проєкт (тут функція буде не чистою, але не повинна мутувати массив):`,
        answer: [
            group
        ]
    }
